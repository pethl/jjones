...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { body: @faq.body, date: @faq.date, keywords: @faq.keywords, title: @faq.title }
    end
  ...
  test "should update faq" do
    put :update, id: @faq, faq: { body: @faq.body, date: @faq.date, keywords: @faq.keywords, title: @faq.title }
    assert_redirected_to faq_path(assigns(:faq))
  end
